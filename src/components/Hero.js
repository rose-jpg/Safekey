        ...
        <div className='flex  md:flex-row flex-col md:justify-between '>
          <div className='flex flex-col sm:mt-24  '>
            <IconContext.Provider value={{ size: "20px" }}>
              <h1 className=' text-[45px] sm:text-[66px] text-white font-clash  sm:leading-[75px] leading-[50px] font-semibold w-[100%] sm:w-[500px]'>
                Protect your <span className='txt'>Web3</span> assets with
                Safekey
              </h1>

              <p className=' text-white font-circular text-sm font-normal w-[100%] md:w-[440px]'>
          ...
          <div className='flex flex-1 justify-end items-center relative sm:mt-0 mt-6'>
            <motion.img
              ...
              src={iphone}
              className=' absolute -left-4 bottom-0 z-[10] w-[170px] lg:w-[334px] md:w-[220px]  '
              alt=''
            />

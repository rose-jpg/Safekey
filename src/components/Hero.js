        ...
        <div className='flex flex-row justify-between '>
          <div className='flex flex-col mt-24  '>
            <IconContext.Provider value={{ size: "20px" }}>
              <h1 className=' text-[66px] text-white font-clash  leading-[75px] font-semibold w-[500px]'>
                Protect your <span className='txt'>Web3</span> assets with
                Safekey
              </h1>
              <p className=' text-white font-circular text-sm font-normal w-[440px]'>
          ...
          <div className='flex flex-1 justify-end items-center relative '>
            ...
            src={iphone} className=' absolute -left-4 bottom-0 z-[10]' alt='' />
